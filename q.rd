<resource schema="mars_craters_lagain">
  ...
  <table id="epn_core" onDisk="true">
    ...
    <meta name="description">
      Revised mars_craters database. Table is in development, please use with caution.
    </meta>
    <stc>
  ...
  <data id="import">
    <sources>data/lagain_db.csv</sources>
    <csvGrammar>
    ...
    <make table="epn_core">
      <rowmaker idmaps="*">
        ...
        <var key="s_region">
          pgsphere.SCircle(pgsphere.SPoint.fromDegrees(@c1min,@c2min),(@radius/(math.pi*3390.0*1000.0/180.0))*pgsphere.DEG).asPoly().asSTCS("UNKNOWNFrame")
        </var>
        ...
        <var key="modification_date">"2019-02-28"</var>
